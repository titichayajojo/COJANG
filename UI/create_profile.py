...
"border-radius: 15px;")
        ...
        self.label_full_name_7 = QLabel(self.centralwidget)
        self.label_full_name_7.setObjectName(u"label_full_name_7")
        self.label_full_name_7.setGeometry(QRect(40, 250, 41, 41))
        self.label_full_name_7.setStyleSheet(u"font: 700 13pt \"Microsoft JhengHei UI\";\n"
"")
        ...
        self.radioButton_male.setGeometry(QRect(120, 260, 89, 20))
        ...
        self.radioButton_female.setGeometry(QRect(240, 260, 89, 20))
        self.label_full_name_8 = QLabel(self.centralwidget)
        self.label_full_name_8.setObjectName(u"label_full_name_8")
        self.label_full_name_8.setGeometry(QRect(40, 300, 141, 41))
        self.label_full_name_8.setStyleSheet(u"font: 700 13pt \"Microsoft JhengHei UI\";\n"
"")
        self.textEdit_id_card = QTextEdit(self.centralwidget)
        self.textEdit_id_card.setObjectName(u"textEdit_id_card")
        self.textEdit_id_card.setGeometry(QRect(40, 340, 301, 31))
        self.textEdit_id_card.setStyleSheet(u"font: 700 12pt \"Microsoft JhengHei UI Light\";\n"
"")
        self.textEdit_id_card.setInputMethodHints(Qt.ImhNone)
        self.label_full_name_9 = QLabel(self.centralwidget)
        self.label_full_name_9.setObjectName(u"label_full_name_9")
        self.label_full_name_9.setGeometry(QRect(40, 390, 141, 41))
        self.label_full_name_9.setStyleSheet(u"font: 700 13pt \"Microsoft JhengHei UI\";\n"
"")
        self.textEdit_nationality = QTextEdit(self.centralwidget)
        self.textEdit_nationality.setObjectName(u"textEdit_nationality")
        self.textEdit_nationality.setGeometry(QRect(40, 430, 301, 31))
        self.textEdit_nationality.setStyleSheet(u"font: 700 12pt \"Microsoft JhengHei UI Light\";\n"
"")
        self.textEdit_nationality.setInputMethodHints(Qt.ImhNone)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_full_name_7.setText(QCoreApplication.translate("MainWindow", u"Sex", None))
        ...
        self.label_full_name_8.setText(QCoreApplication.translate("MainWindow", u"ID card number", None))
        self.textEdit_id_card.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Enter you ID card number", None))
        self.label_full_name_9.setText(QCoreApplication.translate("MainWindow", u"Nationality", None))
        self.textEdit_nationality.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Enter you nationality", None))
    # retranslateUi
