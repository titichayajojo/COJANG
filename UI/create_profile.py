...
"")
        self.label_full_name_2 = QLabel(self.centralwidget)
        self.label_full_name_2.setObjectName(u"label_full_name_2")
        self.label_full_name_2.setGeometry(QRect(40, 150, 91, 41))
        self.label_full_name_2.setStyleSheet(u"font: 700 13pt \"Microsoft JhengHei UI\";\n"
"")
...
"")
        ...
        self.buttonGroup.addButton(self.radioButton_infected)
        self.radioButton_infected.setObjectName(u"radioButton_infected")
        self.radioButton_infected.setGeometry(QRect(160, 120, 89, 20))
        self.radioButton_not_infected = QRadioButton(self.centralwidget)
        self.buttonGroup.addButton(self.radioButton_not_infected)
        self.radioButton_not_infected.setObjectName(u"radioButton_not_infected")
        self.radioButton_not_infected.setGeometry(QRect(270, 120, 89, 20))
        self.radioButton_infected_2 = QRadioButton(self.centralwidget)
        self.buttonGroup_2 = QButtonGroup(MainWindow)
        self.buttonGroup_2.setObjectName(u"buttonGroup_2")
        self.buttonGroup_2.addButton(self.radioButton_infected_2)
        self.radioButton_infected_2.setObjectName(u"radioButton_infected_2")
        self.radioButton_infected_2.setGeometry(QRect(160, 160, 91, 20))
        self.radioButton_not_injected = QRadioButton(self.centralwidget)
        self.buttonGroup_2.addButton(self.radioButton_not_injected)
        self.radioButton_not_injected.setObjectName(u"radioButton_not_injected")
        self.radioButton_not_injected.setGeometry(QRect(270, 160, 91, 20))
...
"border-radius: 15px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_full_name.setText(QCoreApplication.translate("MainWindow", u"Status", None))
        self.label_full_name_2.setText(QCoreApplication.translate("MainWindow", u"Vaccine", None))
        ...
        self.radioButton_not_infected.setText(QCoreApplication.translate("MainWindow", u"Not infected", None))
        self.radioButton_infected_2.setText(QCoreApplication.translate("MainWindow", u"Injected", None))
        self.radioButton_not_injected.setText(QCoreApplication.translate("MainWindow", u"Not Injected", None))
